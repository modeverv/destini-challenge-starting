          ...
          child: Column(
            ...
            children: <Widget>[
              Expanded(
                ...
                child: Center(
                  child: Text(
                    // DONE: Step 10 - use the storyBrain
                    // to get the first story title and display it in this Text Widget.
                    storyBrain.getStory(),
                    style: TextStyle(
                      fontSize: 25.0,
                    ),
                ...
                child: Visibility(
                  ...
                  child: FlatButton(
                    onPressed: () {
                      ...
                      //DONE: Step 19 - Call the nextStory() method from storyBrain and
                      // pass the number 2 as the choice made by the user.
                      setState(() {
...
//DONE: Step 24 - Run the app and try to figure out
// what code you need to add to this file to make the story change
// when you press on the choice buttons.

//DONE: Step 29 - Run the app and test
// it against the Story Outline to make sure
